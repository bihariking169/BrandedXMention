...
async def start(event):
    ...
    await event.client.send_file(
        ...
        link_preview=False,
        buttons=[
            [Button.url("❤️‍🔥 ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ 💫", "https://t.me/secrett_help_bot?startgroup=true")],
            [Button.url("❤️‍🔥 ɢʀᴏᴜᴘ 💫", "https://t.me/ll_SASURAL_ll"), Button.url("❤️‍🔥 ᴄʜᴀɴɴᴇʟ 💫", "https://t.me/BRANDRD_BOT")],
            [Button.url("❤️‍🔥 ʜᴇʀᴜᴋᴏ ᴄᴄ 💫", "https://t.me/ll_SASURAL_ll"), Button.url("❤️‍🔥 BRANDED ❤️‍🔥", "https://t.me/BRANDEDKING82")]
        ]
    )
...
async def help(event):
    ...
    await event.reply(
        ...
        buttons=(
            [
                Button.url("❤️‍🔥 ꜱᴜᴘᴘᴏʀᴛ 💫", "https://t.me/ll_SASURAL_ll"),
                Button.url("❤️‍🔥 ʏᴏᴜᴛᴜʙᴇ 💫", "https://t.me/ll_SASURAL_ll"),
            ]
        ),
    )
